...
export const CollectNavbar = () => {
  ...
  return (
    <div ref={mobileWrapRef} className="sticky top-3 z-50 px-6">
      ...
      >
        <Link
          to={paths.app.collect.dashboard.getHref()}
        ...
        >
          ...
          <span className="text-[13px] font-medium text-brand-amber">Collect</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to={paths.app.collect.profile.getHref()} className="shrink-0">
