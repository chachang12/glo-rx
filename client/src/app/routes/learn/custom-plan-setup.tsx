...
export const CustomPlanSetup = () => {
  ...
  const handleFileChange = useCallback(async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setError(null)
    try {
      const doc = await uploadMutation.mutateAsync({ planId, file })
  ...
  }, [planId, topics, navigate, confirmMutation])
